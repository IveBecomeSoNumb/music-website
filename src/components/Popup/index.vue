    ...
    <div class="popup" :class="{'playMode': playModeVisible}">
        ...
        <mt-popup class="playListSheet" v-model="playListVisible" position="bottom">
            <div class="playList-header">
                <div class="playList-mode-btn left" @click="clearablePlayList">Clear</div>
                <div class="playList-title">PlayList<span class="playList-count">（{{playList.length}}）</span>
                </div>
            ...
            <div class="playList-nothing" v-else>nothing here</div>
        </mt-popup>
